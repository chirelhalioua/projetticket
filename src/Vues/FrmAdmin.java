...
public class FrmAdmin extends javax.swing.JFrame {
    ...
    private void formWindowOpened(java.awt.event.WindowEvent evt) {//GEN-FIRST:event_formWindowOpened
        ...
        // mise à jour des données du jTable
    ...
    private void tblUsersMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tblUsersMouseClicked
        ...
        mdlTicket.loadDatasT(fm.GetAllTicketsByIdUser(idUser));
    ...
    private void btnInsererNouveauTicketMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btnInsererNouveauTicketMouseClicked
        ...
        if(txtNomTicket.getText().compareTo("") == 0)
        {
            ...
            JOptionPane.showMessageDialog(null,
                    "Saisir le nom du ticket", "Erreur de saisie",
...
// On créer le nouveau ticket avec les données saisies ainsi que l'état
// Ticket unTicket = new Ticket(fm.GetLastIdTicket(),txtNomTicket.getText(),

            // Insertion du nouveau ticket
            fm.InsererTicket(fm.GetLastIdTicket(),txtNomTicket.getText(),
                 formatter.format(date), idUser, etat);
            // On recharge le modèle car il y a un nouveau ticket
            mdlTicket.loadDatasT(fm.GetAllTicketsByIdUser(idUser));
            // Mise à jour du modèle du JTable
            tblTickets.setModel(mdlTicket);
            // On remet à blanc le nom du ticket
